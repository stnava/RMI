...
dataframe \newline \newline
```{r,out.width='.4\\linewidth',results='show',eval=FALSE,echo=TRUE}
...
```{r,out.width='.4\\linewidth',eval=FALSE,results='show',echo=FALSE}
...
```{r,out.width='.35\\linewidth',dev='pdf',eval=FALSE,results='show',echo=TRUE}
...
```{r,out.width='.6\\linewidth',dev='pdf',echo=TRUE,eval=FALSE,results='hide'}
...
```{r,myio,echo=TRUE,eval=FALSE,warning=FALSE,results='show',fig.width=4,fig.height=4,out.width='.45\\linewidth'}
...
```{r,myviz,echo=TRUE,eval=FALSE,warning=FALSE,results='hide',fig.width=4,fig.height=4,out.width='.8\\linewidth'}
orthographic( as.array( colina ), oma=rep(2,4))
```

## Quickly Show Images w/ANTsR
```{r,myviza,echo=TRUE,warning=FALSE,eval=FALSE,tidy=TRUE,results='hide',fig.width=4,fig.height=4,out.width='.9\\linewidth'}
...
```{r,convvec,echo=TRUE,warning=FALSE,eval=FALSE,tidy=TRUE,results='hide',fig.width=4,fig.height=4,out.width='.4\\linewidth'}
imgvec<-colina[  colina > 50  ]
print( length( imgvec ) )
```
Use  oro.nifti to convert an image to a vector.
```{r,convvec2,echo=TRUE,warning=FALSE,eval=FALSE,tidy=TRUE,results='hide',fig.width=4,fig.height=4,out.width='.4\\linewidth'}
...
\transdissolve
```{r,multivar,echo=TRUE,eval=FALSE,results='hide',warning=FALSE}
...
```{r sccanviz,echo=FALSE,out.width='.6\\linewidth',message=FALSE,warning=FALSE,eval=FALSE}
...
```{r,anova1,echo=TRUE,eval=FALSE,results='show',warning=FALSE,out.width='.4\\linewidth'}
...
## ANOVA 1
```{r,anova1ph,echo=TRUE,eval=FALSE,results='show',warning=FALSE}
...
How do we assess the importance of multiple predictors acting together
within classic regression?
```{r,anova2,echo=1:3,eval=FALSE,results='show',warning=FALSE}
...
```{r,out.width='.8\\linewidth',eval=FALSE,show='hide',echo=FALSE}
...
```{r,out.width='.85\\linewidth',dev='pdf',echo=FALSE,eval=FALSE}
PCbiplot(fit)
```
...
Also easy in *R*
(SVD used internally):
```{r,out.width='.4\\linewidth',echo=TRUE,eval=FALSE,results='hide'}
...
```{r,out.width='.7\\linewidth',dev='pdf',echo=TRUE,eval=FALSE,warning=FALSE,results='show'}
print( mycca )
```
...
```{r,out.width='.65\\linewidth',dev='pdf',echo=TRUE,eval=FALSE,warning=FALSE,results='hide'}
...
```{r,out.width='.4\\linewidth',eval=FALSE,results='hide',echo=TRUE}
inmask <-  mask > 0.5
...
```{r,out.width='.7\\linewidth',dev='pdf',eval=FALSE,results='show',echo=TRUE}
pheatmap( cor( pbacTRcog ) , cluster_rows = F , cluster_cols =  F )
```


## *R* Multivariate: Inspect Data - PBAC Cog Constellation Plot
```{r,out.width='.75\\linewidth',dev='pdf',eval=FALSE,results='show',echo=FALSE}
stars( pbacTRcog,
...
```{r,out.width='.8\\linewidth',dev='pdf',eval=FALSE,results='show',echo=FALSE}
...
```{r,out.width='.3\\linewidth',dev='pdf',eval=FALSE,results='show',echo=TRUE}
...
```{r,out.width='.6\\linewidth',dev='pdf',echo=2,eval=FALSE,results='hide'}
nv<-10
...
## *R* Multivariate: PBAC SCCAN
```{r,out.width='.6\\linewidth',dev='pdf',echo=FALSE,eval=FALSE,results='show'}
for ( ind in 1:nv ) {
...
```{r,echo=FALSE,warning=FALSE,eval=FALSE,tidy=TRUE,results='hide'}
...
```{r,predictpbac0,echo=1:2,warning=FALSE,eval=FALSE,tidy=TRUE,results='show',fig.width=4,fig.height=4,out.width='.4\\linewidth',dev='pdf'}
...
```{r,predictpbac,echo=TRUE,warning=FALSE,eval=FALSE,tidy=TRUE,results='show',fig.width=4,fig.height=4,out.width='.4\\linewidth',dev='pdf'}
```{r,out.width='.6\\linewidth',dev='pdf',echo=FALSE,eval=FALSE,results='show'}
for ( ind in 1:nv ) {
  mytests<-names( pbacTRcog )[ abs( mysccan$eig1[,ind] ) > 0 ]
  myform<-paste( mytests , collapse="+" )
...
## Prediction: PBAC---Cognition from Brain
```{r,predictpbac2a,echo=TRUE,warning=FALSE,eval=FALSE,tidy=TRUE,results='show',fig.width=4,fig.height=4,out.width='.7\\linewidth',dev='pdf'}
ind=2
mytests<-names( pbacTRcog )[ abs( mysccan$eig1[,ind] ) > 0 ]
myform<-paste( mytests , collapse="+" )
...
## Prediction: PBAC---Cognition from Brain
```{r,predictpbac2b,echo=FALSE,warning=FALSE,eval=FALSE,tidy=TRUE,results='show',fig.width=4,fig.height=4,out.width='.7\\linewidth',dev='pdf'}
ind=2
print( paste("Test Correlation:",names(pbacTEcog)[ which( mysccan$eig1[,ind ] > 0 )],  cor.test( cogtest, gmtest )$est  ) )
visreg( predmdl )
```
...
```{r,boldmotor1,echo=TRUE,warning=FALSE,eval=FALSE,tidy=TRUE,results='hide',fig.width=4,fig.height=4,out.width='.4\\linewidth'}
...
```{r,boldmotor2,echo=TRUE,warning=FALSE,eval=FALSE,tidy=TRUE,results='hide',fig.width=4,fig.height=4,out.width='.4\\linewidth'}
...
```{r,boldmotor3,echo=TRUE,warning=FALSE,eval=FALSE,tidy=TRUE,results='hide',fig.width=4,fig.height=4,out.width='.4\\linewidth'}
...
```{r,boldmotor4,echo=TRUE,warning=FALSE,eval=FALSE,tidy=TRUE,results='hide',fig.width=4,fig.height=4,out.width='.4\\linewidth'}
...
```{r,boldmotor5a,echo=FALSE,warning=FALSE,eval=FALSE,tidy=TRUE,results='hide',fig.width=4,fig.height=4,out.width='.8\\linewidth'}
  mx<-max( betas )
...
```{r,boldmotor5b,echo=FALSE,warning=FALSE,eval=FALSE,tidy=TRUE,results='hide',fig.width=4,fig.height=4,out.width='.8\\linewidth'}
 if ( ! exists("mymni") ) {
...
```{r,boldmotor6,echo=TRUE,warning=FALSE,eval=FALSE,tidy=TRUE,results='hide',fig.width=4,fig.height=4,out.width='.4\\linewidth'}
...
```{r,boldlang,echo=FALSE,warning=FALSE,eval=FALSE,tidy=TRUE,results='hide',fig.width=4,fig.height=4,out.width='.4\\linewidth'}
...
```{r,boldmotor5,echo=FALSE,warning=FALSE,eval=FALSE,tidy=TRUE,results='hide',fig.width=4,fig.height=4,out.width='.8\\linewidth'}
  mx<-max( betas )
  plot( avg, list(betaimg),  axis = 3, window.overlay=c(3,max(betaimg)))
```


## BOLD Language Task MV

```{r,boldlangMV,echo=FALSE,warning=FALSE,eval=FALSE,tidy=TRUE,results='hide',fig.width=4,fig.height=4,out.width='.4\\linewidth'}
# quick multivariate version
rmat<-residuals( lm( mat ~ 0 + . ,  data = data.frame( nuis )  ) )
cblock <- as.numeric(hrf[5:length(hrf)])
cblock2 <- as.numeric( cblock > 0 )
mypreds<-as.matrix( cbind( cblock, cblock2 ) )
sccan<-sparseDecom2( inmatrix=list( desmat[5:length(hrf),] , mypreds ), 
   inmask = c( mask , NA ) , sparseness=c( 0.05, 0.5 ), nvecs=4, 
   its=10, smooth=0.5, perms=0, cthresh = c(10, 0) )
plot( avg, sccan$eig1[[1]] %>% iMath("Normalize") , window.overlay=c(0.1,1), axis=3)
#
# eigenanatomy
#
