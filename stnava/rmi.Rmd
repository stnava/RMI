...
```{r sccanviz,echo=FALSE,out.width='.8\\linewidth',message=FALSE,warning=FALSE}
...
```{r,myhelpers1,echo=TRUE,warning=FALSE,eval=TRUE,tidy=TRUE,results='hide',fig.width=4,fig.height=4,out.width='.4\\linewidth'}
...
from its average.
```{r,myhelpers2,echo=TRUE,warning=FALSE,eval=TRUE,tidy=TRUE,results='hide',fig.width=4,fig.height=4,out.width='.4\\linewidth'}
...
```{r,myhelpers3,echo=TRUE,warning=FALSE,eval=TRUE,tidy=TRUE,results='hide',fig.width=4,fig.height=4,out.width='.4\\linewidth'}
...
```{r,boldmotor1,echo=FALSE,warning=FALSE,eval=TRUE,tidy=TRUE,results='hide',fig.width=4,fig.height=4,out.width='.4\\linewidth'}
...
```{r,boldmotor5,echo=FALSE,warning=FALSE,eval=TRUE,tidy=TRUE,results='hide',fig.width=4,fig.height=4,out.width='.4\\linewidth'}
  mx<-max( betas )
...
```{r,boldmotor8,echo=TRUE,warning=FALSE,eval=FALSE,tidy=TRUE,results='hide',fig.width=4,fig.height=4,out.width='.4\\linewidth'}
nvecs<-11
...
```{r,boldmotor8b,echo=FALSE,warning=FALSE,eval=FALSE,tidy=TRUE,results='hide',fig.width=4,fig.height=4,out.width='.4\\linewidth'}
...
Use multivariate decomposition to help understand both the data and
the nuisance variables.
```{r,boldmotor9,echo=1,warning=FALSE,eval=FALSE,tidy=TRUE,results='show',fig.width=4,fig.height=4,out.width='.4\\linewidth'}
...
Use multivariate decomposition to help understand both the data and
the nuisance variables.
```{r,boldmotor10,echo=1,warning=FALSE,eval=FALSE,tidy=TRUE,results='show',fig.width=4,fig.height=4,out.width='.4\\linewidth'}
...
Use multivariate decomposition to help understand both the data and
the nuisance variables.
```{r,boldmotor9v,echo=1,warning=FALSE,eval=FALSE,tidy=TRUE,results='hide',fig.width=4,fig.height=4,out.width='.4\\linewidth'}
  eigimg <- ff$eigenanatomyimages[[2]]
  eigimg=iMath(eigimg,"Normalize")
plot(myantsimage = avg, functional = list(eigimg),
  axis = 3, window.overlay = c(0.01,1),
...
Use multivariate decomposition to help understand both the data and
the nuisance variables.
```{r,boldmotor10v,echo=1,warning=FALSE,eval=FALSE,tidy=TRUE,results='hide',fig.width=4,fig.height=4,out.width='.4\\linewidth'}
eigimg <- ff$eigenanatomyimages[[1]] %>% iMath("Normalize")
plot( avg, list(eigimg),  axis = 3, window.overlay = c(0.1,1) )
```
\begin{figure}[b]
...
```{r,boldlang,echo=TRUE,warning=FALSE,eval=FALSE,tidy=TRUE,results='hide',fig.width=4,fig.height=4,out.width='.4\\linewidth'}
if ( FALSE ) {
...
print( colnames( nuis ) )
plot(  avg,  list(mask),
  axis = 3, window.overlay = c(0.5,1.5))
betas<-rep(NA, ncol( mat ) )
for ( i in 1:ncol(mat) )
  {
  vox<-mat[ , i ]
...
print( mx )
th<-c(3,mx)
plot( avg,  list(betaimg),  axis = 3, window.overlay = th )
